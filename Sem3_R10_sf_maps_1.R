...
# .. Note: "centerpoint" lattitude and longite arguments should be adjusted to match plotted data....
...
#
## Quick exercise
## Print plot of the Czech & Slovak Republics at NUTS3 level, 
## add NUTS2 borders, use "laea" projection
##